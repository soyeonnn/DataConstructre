...
class CustomerServiceCenter:
    ...
    def process_complaint(self):
        ...
        if not self.queue:
            ...
            client_complaint = self.queue.popleft()
            print("{}님의 {} 문의 내용 접수 되었습니다. 담당자가 배정되면 {}로 연락드리겠습니다!".format(client_complaint.name, client_complaint.content, client_complaint.email))
